...
> a ballot. This is distinct from proposals in the
> [Proposal Module](https://proposals.docs.ekklesia.vote/), which manages the
> submission and review process before something reaches a ballot.
